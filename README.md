...
기술의 가치를 넘어 팀의 가능성을 함께 확장하는 최도영입니다!

- 🌱 **학습 중**: Spring Security / OAuth2, Clean Architecture, Docker & Linux
- 💡 **관심사**:AI 트렌드, DevOps 문화와 자동화, 클라우드 네이티브 기술, 확장 가능한 백엔드 시스템
...
<div align="center">
  <strong>Email</strong>: gisang0927@gmail.com
</div>
